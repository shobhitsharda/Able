...
if(check == "1")	//view cloud post
{
	out.println("ERROR in viewing cloud post. Try Again");
}
else if(check == "2")	//submitting standard info
{
	out.println("ERROR in subitting the info. Try Again");
}
else if(check == "3")	//displaying the reviews
{
	out.println("ERROR in displaying the reviews. Try Again");
}
