...
%>
    ...
    <div id="column">
        <div>
            <ul class="menu">
				<li class="active"><a href="/ABLE/anonymous/physicaldisability/Std_PhysicalDisabilityCloud.jsp">Physical &nbsp;Challenges</a></li>
	...
	<div id="bigcontent">	
	    <% out.println("<a class=\"size1\" id=\"j1\" href=\"/ABLE/Std_ViewCloudPost?type=deaf\">deaf</a>"); %>
	
	<li>
	    <% out.println("<a class=\"size2\" id=\"j2\" href=\"/ABLE/Std_ViewCloudPost?type=blind\">blind</a>"); %>
	<li>
	    <% out.println("<a class=\"size3\" id=\"j3\" href=\"/ABLE/Std_ViewCloudPost?type=dumb\">dumb</a>");  %>					
     </li>
	<li>
	    <% out.println("<a class=\"size4\" id=\"j4\" href=\"/ABLE/Std_ViewCloudPost?type=loudness\">loudness</a>"); %>
    </li>
	<% out.println("<a class=\"size5\" href=\"/ABLE/Std_ViewCloudPost?type=genetics\">genetics</a>"); %>
	<% out.println("<a class=\"size6\" href=\"/ABLE/Std_ViewCloudPost?type="+"noise"+"\">noise</a>"); %>
	<% out.println("<a class=\"size3\" href=\"/ABLE/Std_ViewCloudPost?type="+"stuttering"+"\">stuttering</a>"); %>
