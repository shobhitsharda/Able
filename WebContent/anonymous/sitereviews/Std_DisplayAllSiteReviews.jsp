		...
		%>
			...
			<div id="column">
				<div>
					...
					<li class="active"><a href="/ABLE/Std_DisplayAllSiteReviews">Site Links</a></li>    
...
%>
					...
					<h2><% out.print("Type Of Disability :" + data.getLink_type() ); %></h2>
					<p><% out.println("Link :" + data.getLink()); %></p>
					<p><% out.print("Post Date :" + data.getLinkdate());%></p>
					<p><% out.print("Posted By :" + data.getEmail());%></p>
					<p><% out.print("Description :" + data.getDescription());%></p>	
						<!-- CONTENT END -->
					</div>
<%
i++;
