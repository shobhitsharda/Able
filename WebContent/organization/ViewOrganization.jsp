...
%>
	...
	<% }
		%>				<!-- TOP MENU -->
			...
			<div id="bigcontent">
			<!-- CONTENT START -->
			<h1 class="heading" align="center" color: #000000>Organizations</h1>
					<!-- 	<h2>Organizations</h2>  -->
<%
...
%>			
				<div id="content">
					<div>
						...
						<p><h3><%out.println(data.getOrgname()); %></h3><br>
						<% out.print(data.getOrgaddress()); %><br>
						<% out.print(data.getOrgcity());%><br>
						<%out.print( data.getOrgpincode());%><br>
						<%out.print( data.getOrgwebsite());%>
