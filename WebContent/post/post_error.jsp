...
if(check == "1")	//submit post
{
	out.println("ERROR in submitting post.Please Try Again");
}
else if(check == "2")	//view accepted post
{
	out.println("ERROR in viewing the accepted post. Try Again");
}
else if(check == "3")	//view pending post
{
	out.println("ERROR in viewing pending post");
}
