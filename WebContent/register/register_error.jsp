...
if(check == "1")
{
	out.println("ERROR in viewing profile. Try Again");
}
else if(check == "2")		//internal problem with the database
{
	out.println("ERROR..!Unable to register.Try Again");
}
else if(check == "3")	//passwords entered are not same
{
	out.println("ERROR..!Password entered are not same. Try again");
}
