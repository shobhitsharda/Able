...
if(check == "1")	//submit reviews
{
	out.println("ERROR in submitting the reviews.Try Again");
}
else if(check == "2")
{
	out.println("ERROR in viewing accepted reviews. Try Again");
}
else if(check == "3")
{
	out.println("ERROR in viewing pending reviews. Try Again");
}
