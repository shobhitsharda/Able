...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/ABLE/css/register.css"  />
...
%>
    ...
    <div id="column">
        <div>
			...
			<li class="active"><a href="/ABLE/ViewRules">Legal Info</a></li>
	...
	<div id="bigcontent">
		...
		<h1 class="heading" align="center" color: #000000>Legal Information</h1>
<%
...
%>	
		<div id="post">
			    <!-- CONTENT START -->
			<h2><% out.print(data.getRuletitle()); %></h2> 
          <img src="/ABLE/images/pils.gif" style="padding-left:10px "align="right"/> 
			<p><% out.print(data.getRulecontent()); %></p>
			    <!-- CONTENT END --> 
            <blockquote>
...
%>
		<a href="/ABLE/index.jsp" style="font-size:23px">Return to Home</a>
    </div>
    <div id="footer">
		<p><!-- COPYRIGHT INOFRMATION -->Content &copy; 2010 square0ne.<!-- COPYRIGHT INOFRMATION END -->Design &copy; squareOne Amrita School Of Engg.</p>
	</div>
</div>
</body>
</html>
