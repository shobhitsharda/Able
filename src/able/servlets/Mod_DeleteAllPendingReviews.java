...
import able.helper.CheckMod_DeleteAllPendingReviews;
import able.helper.CheckMod_ViewAllPendingReviews;

/**
 * Servlet implementation class for Servlet: Mod_DeleteAllPendingReviews
 *
 */
 public class Mod_DeleteAllPendingReviews extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public Mod_DeleteAllPendingReviews() {
		super();
	}   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			CheckMod_DeleteAllPendingReviews cmdu = new CheckMod_DeleteAllPendingReviews();
			return_value = cmdu.deletemod_allpendingreviews(mod_linkid);
			...
			{
				check = "2"; //mod delete all pending reviews
